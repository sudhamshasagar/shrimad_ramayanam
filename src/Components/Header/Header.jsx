...
function Header() {
    ...
    return(
        <div className="navigation" style={{width: isOpen? '25%': '100vw', backgroundColor: isOpen? 'rgba(251, 252, 253, 0.95)': 'white', boxShadow: isOpen? '2px 0px 5px rgba(0, 0, 0, 0.2)':'none', height: isOpen? '100%': '5vh'}}>
            <div className="icon">
                {isOpen ? (
